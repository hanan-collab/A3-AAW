      ...
      channel.consume(QUEUE_NAME, async (msg) => {
        ...
        try {
          ...
          if (event.event === "order.placed") {
            ...
            const msgText = `Hi ${customerName}, your rental order for ${lensName} has been placed successfully. Order ID: ${orderId}`;
            ...
            console.log(`Notification recorded and broadcasted for order ${orderId}`);
          }
